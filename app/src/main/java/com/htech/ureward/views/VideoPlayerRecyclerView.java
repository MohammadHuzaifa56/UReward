package com.htech.ureward.views;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private ArrayList<VideoModel> mediaObjects = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if (holder == null) {
            UHelper.LogCat("Null Holder Called");
            playPosition = -1;
            return;
        }
        thumbnail = holder.imageView;
        progressBar = holder.lottieAnimationView;
       ...
       // requestManager = holder.requestManager;
        ...
        UHelper.LogCat("Media Url "+mediaUrl);
        new YouTubeExtractor(context)
        {
            ...
            protected void onExtractionComplete(SparseArray<YtFile> ytFiles, VideoMeta videoMeta) {
                if (ytFiles!=null) {
                    ...
                    videoPlayer.setMediaSource(new MergingMediaSource(
                                    true,
                                    videoSource,
                                    audioSource),
                            true
   ...
   /*     DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(
        ...
        UHelper.LogCat("Media Url "+mediaUrl);
        if (mediaUrl != null) {
            UHelper.LogCat("media url called");
...
/*    private void setVolumeControl(VolumeState state){
   ...
   /* private void animateVolumeControl(){
    ...
    public void setMediaObjects(ArrayList<VideoModel> mediaObjects){
